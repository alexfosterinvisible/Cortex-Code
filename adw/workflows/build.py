...
from adw.git_ops import commit_changes, finalize_git_operations, get_current_branch
from adw.github import fetch_issue, make_issue_comment, get_repo_url, extract_repo_path
from adw.workflow_ops import (
    implement_plan,
    create_commit,
    format_issue_message,
    AGENT_IMPLEMENTOR,
)
from adw.utils import setup_logger, check_env_vars
from adw.data_types import GitHubIssue
from adw.worktree_ops import validate_worktree
...
def main():
    ...
    if not issue_command:
        ...
        from adw.workflow_ops import classify_issue
