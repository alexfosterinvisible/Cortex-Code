...
Usage: uv run python -m adw.workflows.wt.plan_build_test_review_iso <issue-number> [adw-id] [--skip-e2e] [--skip-resolution]
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage: uv run python -m adw.workflows.wt.plan_build_test_review_iso <issue-number> [adw-id] [--skip-e2e] [--skip-resolution]")
